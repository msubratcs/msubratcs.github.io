...
tags: [cystic-fibrosis, pubmed, mesh, postgres, prefect, etl, parquet]
...
Parsing a handful of affiliations by hand is a weekend. Parsing 97,000 of them is a career. That is the problem [Part 2]({% post_url 2026-04-12-cf-research-network-analysis-part2-institution-disambiguation %}) solves.
...
Both problems are forms of entity resolution. [Part 2]({% post_url 2026-04-12-cf-research-network-analysis-part2-institution-disambiguation %}) tackles the institution version using LLM-based affiliation parsing and a geo-search API. [Part 3]({% post_url 2026-04-12-cf-research-network-analysis-part3-author-disambiguation %}) tackles the author version with a temporal-aware disambiguation algorithm.

---

*Next: [Part 2: From Messy Affiliations to a Master List of Institutions with LLMs]({% post_url 2026-04-12-cf-research-network-analysis-part2-institution-disambiguation %})*

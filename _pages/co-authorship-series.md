...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part1-data-pipeline %}">Part 1: Building a Real-Time Biomedical Research Intelligence Pipeline</a></h3>
...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part2-institution-disambiguation %}">Part 2: Resolving 57,000 Affiliation Strings to 5,800 Research Organizations</a></h3>
...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part3-author-disambiguation %}">Part 3: Disambiguating 43,000 Author Names with Temporal Intelligence</a></h3>
<p>ORCID anchoring, collision-aware matching, temporal career transitions, and achieving F1=0.9996 against ground truth.</p>
</li>

<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part4-network-structure %}">Part 4: The Small World of CF Research</a></h3>
...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part5-trikafta-effect %}">Part 5: The Trikafta Effect: How a Drug Approval Rewired a Research Community</a></h3>
...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part6-geography-institutions %}">Part 6: The Institutional Backbone and Geography of CF Research</a></h3>
...
<li>
<h3><a href="{% post_url 2026-04-09-co-authorship-part7-graph-ml %}">Part 7: Research DNA, Innovation Catalysts, and Knowledge Diffusion</a></h3>
